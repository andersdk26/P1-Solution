...
const static char prioritisationInstructions[] = "Please enter your preferred order of prioritisation. Input a number from 1 to 3 for each category. Two categories can not have the same priority. Press 'ENTER' to finish.";
